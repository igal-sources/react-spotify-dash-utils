...
class Player extends Component {
  constructor(props) {
    ...
    this.state = {
      token:
        "BQBmPV0TFOmeHn77iyXEGxIxbEsQ-GeXSM5krnL8huHN7vK8r87cObOyeaCzP3ONaqPRXXcmp0P9aJYec9kJe4PVGvDw22wkaudLHhotwEVs0t-OHvpNHxdhs48dCFiDciBP0b2lU1jQz66SOxnCdKuwZHfN4gJ0-g6ozZqzmIQuY8t0j2c-AwRHTBEtpT77191iS_c08LvyGeA",
      deviceId: "1545869d9ca7c6dde129b6d9281cf752f019e232",
      loggedIn: false,
      error: "",
  ...
  transferPlaybackHere() {
    ...
    fetch("https://api.spotify.com/v1/me/player", {
      ...
      data: '{"uris": ["spotify:artist:6HQYnRM4OzToCYPpVBInuU"]}',
      body: JSON.stringify({
        device_ids: [deviceId],
        "context_uri": "spotify:artist:6HQYnRM4OzToCYPpVBInuU",
